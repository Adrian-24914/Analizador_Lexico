...
import { minimizeDFA } from '../src/6-partitions'
import { minimizeDFAWithMyhill } from '../src/6-myhill'
...
describe('minimización del AFD', () => {
    ...
    it('minimiza con Myhill sin cambiar el lenguaje', () => {
        const dfa = nfaToDFA(postfixToNFA(regexToPostfix('a|b')))
        const minimized = minimizeDFAWithMyhill(dfa)
